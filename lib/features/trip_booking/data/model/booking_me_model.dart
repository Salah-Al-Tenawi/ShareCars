  ...
  class BookingMe {
    ...
    factory BookingMe.fromJson(Map<String, dynamic> json) {
      return BookingMe(
        ...
        passengerCommunicationNumber: json['passenger_communication_number'] ?? "",
        driverCommunicationNumber: json['driver_communication_number'] ?? "",
        rideId: json['ride_id'] ?? 0,
        pickupAddress: json['pickup_address'] ?? "",
        destinationAddress: json['destination_address'] ?? "",
        departureTime: DateTime.tryParse(json['departure_time'] ?? "") ?? DateTime.now(),
        ...
        driverRating: (json['driver_rating'] is num) ? (json['driver_rating'] as num).toDouble() : 0.0,
  ...
  String bookingMeModelToJson(BookingMeModel data) =>
